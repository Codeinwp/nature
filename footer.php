    ...
    <footer itemscope itemtype="http://schema.org/WPFooter" id="footer" role="contentinfo" class = "footer grey-bg">
        ...
        <div class="container">
	        ...
	        <div class="powered-by">
	            <a class="" href="http://themeisle.com/themes/nature/" rel="nofollow">Nature </a> <?php esc_html_e('powered by','llorix-one-lite'); ?> <a class="" href="http://wordpress.org/" rel="nofollow"><?php esc_html_e('WordPress','llorix-one-lite'); ?></a>
	        </div>
