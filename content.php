...
<article itemscope itemprop="blogPosts" itemtype="http://schema.org/BlogPosting" itemtype="http://schema.org/BlogPosting" <?php post_class( 'border-bottom-hover' ); ?> title="<?php echo esc_attr__( printf( esc_html__( 'Blog post: %s', 'naturelle' ), get_the_title() ), 'naturelle' ); ?>">
